...
# Load local env.py if present (gitignored). Lets us set SECRET_KEY,
# DEVELOPMENT, DATABASE_URL, etc. for local dev without committing secrets.
...
# Use DATABASE_URL (Heroku Postgres) when set, otherwise fall back to SQLite.
